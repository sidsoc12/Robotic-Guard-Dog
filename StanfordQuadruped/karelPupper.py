...
class Pupper:      
    ...
    radians / s.
    Extra offset helps to tune the value 
    '''
    # TODO: Step 7. Implement a turn function that will turn Pupper using the turn_for_time command. You can use the extra_offset to tune Pupper's movement
    def turn(self, angle, speed, extra_offset = 0.0, behavior=BehaviorState.TROT):
        pass 
